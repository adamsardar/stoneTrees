...
#'    \item{\code{...}{other methods are of minimal interest to a general user} }
#' ' }
#'
#' @examples
#' library(igraph)
...
#'
#' #Run two bootstrap routines (resample fixed terminals and solve) and ALSO run the sub-optimal solution searcher thrice
